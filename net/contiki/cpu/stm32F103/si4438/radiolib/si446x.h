...
#define RF_NIRQ_ENABLE( )				//config nirq() void dfklsajf(vpid)
#define RF_NIRQ_DISABLE( )				//config nirq
#define RF_NIRQ_CFG( )					SI4432_NIRQ_Config( ) 
#define RF_SPINSEL(a)					SI4432NSEL(a) 
#define RF_SDN(a)						SI4432SDN(a)
#else
#define RF_NIRQ_ENABLE( )				//config nirq() void dfklsajf(vpid)
#define RF_NIRQ_DISABLE( )				//config nirq
#define RF_NIRQ_CFG( )					//config nirq pin 
#define RF_SPINSEL(a)					//SI4438NSEL(a) 
#define RF_SDN(a)						//SI4432SDN(a)
#endif
